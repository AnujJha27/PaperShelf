...
export function TopBar({ onMenu }: { onMenu: () => void }) {
  ...
  return <Box component="header" sx={{ height: 68, borderBottom: 1, borderColor: "divider", bgcolor: "background.default", display: "flex", alignItems: "center", px: { xs: 1.5, sm: 3 }, gap: 1.5, position: "sticky", top: 0, zIndex: 10 }}>
