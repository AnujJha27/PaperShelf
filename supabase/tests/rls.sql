...
select is(
  (select title from public.papers where id = '00000000-0000-0000-0000-000000000010'),
  'Shared paper',
...
select is(
  (select host from public.paper_sources where id = '00000000-0000-0000-0000-000000000011'),
  'example.test',
